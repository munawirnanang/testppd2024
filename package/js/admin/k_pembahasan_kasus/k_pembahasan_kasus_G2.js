var main = function(){
    controller = "index.php/K_pembahasan_kasus_G2";
    ...
    //                console.log(settings);
                ...
                success:function(response){
                    ...
                    if(obj)//if json data
                    {
                        ...
                        if(obj.status === 1){
                            ...
                            $('form#form_dpk div[name="rm"]').html(obj.remedial);
                            $('form#form_dpk input[name="remedial_l"]').val(obj.remedial_l);
                            $('form#form_dpk div[name="rk"]').html(obj.rujukan);
                            $('form#form_dpk input[name="rujukan_l"]').val(obj.rujukan_l);
        ...
        $(".wrapper_remedial").on('click', '.inp_r_remedila', function(e){
            //alert();
            $(".hidden_remedial").hide();
            if (this.value == '4') {
                    $(".hidden_remedial").show();
            }
        });
        
        $(".wrapper_rujukan").on('click', '.inp_r_rujukan', function(e){
            //alert();
            $(".hidden_rujukan").hide();
            if (this.value == '4') {
                    $(".hidden_rujukan").show();
