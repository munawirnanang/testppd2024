var main = function(){
    controller = "index.php/M_management";
...
//                                        goToMessage(msg_obj);
                ...
                success:function(response){
                    ...
                    if(obj)//if json data
                    {
                        ...
                        if(obj.status === 1){
                            ...
                            $('form#form_edit input[name="code"]').val(obj.data[0].userid);
                            $('form#form_edit input[name="name"]').val(obj.data[0].name);
                            $('form#form_edit select[name="group"]').html(obj.str_pr);
                            $('form#form_edit select[name="stts"]').html(obj.str_stts);
                            $('form#form_edit select[name="plant"]').html(obj.str);
                            $('form#form_edit select[name="mitra"]').val(obj.data[0].mitra);
                            $(".plant_wrapper_edit").hide();
                            if(obj.hasPlant=='Y')
                                
                                $(".plant_wrapper_edit").show();
        ...
        table.on('click', 'a.reset', function(e){
            e.preventDefault();
            var id      = $(this).data("id");
            var msg_obj = $("#msg");
            ajax_url = controller+"/detail_get";
            ...
            jQuery.ajax({
                ...
                success:function(response){
                    ...
                    if(obj)//if json data
                    {
                        ...
                        if(obj.status === 1){
                            loading.hide();
                            $('form#form_p input[name="id"]').val(obj.id);
                            $('form#form_p input[name="code"]').val(obj.data[0].userid);
                            $('form#form_p input[name="name"]').val(obj.data[0].name);
//                            $('form#form_p select[name="group"]').html(obj.str_pr);
//                            $('form#form_p select[name="stts"]').html(obj.str_stts);
//                            $('form#form_p select[name="plant"]').html(obj.str);
//                            $('form#form_p select[name="mitra"]').val(obj.data[0].mitra);
                            $(".plant_wrapper_edit").hide();
//                            if(obj.hasPlant=='Y')
//                                
//                                $(".plant_wrapper_edit").show();
                            $('#modal_atur').modal('show');
                        }
                        //error msg
                        else if(obj.status === 0){
                            loading.hide();
...
//                    dataType:"text", // Data type, HTML, json etc.
        ...
        form_p.validate({
            ...
            submitHandler: function(form) {
                ...
                // maybe disabling submit button
                // then:
                var data1 = new FormData(form_p[0]);
                var url = controller+"/detail_c_p";
//                var data = form_e.serialize();
                data1.append(csrf_name, $("#csrf").val());
                var data = data1;
...
//                    dataType:"text", // Data type, HTML, json etc.
        ...
        $("#select_plantadd").change(function(e){
            e.preventDefault();
            var _self = $(this);
            $(".plant_wrapper").hide();
            if(_self.val()=='G3'||_self.val()=='G2'||_self.val()=='G5'){
                $(".plant_wrapper").show();
            }
        });
        $("#select_plantedit").change(function(e){
            e.preventDefault();
            var _self = $(this);
            $(".plant_wrapper_edit").hide();
            if(_self.val()=='G3'||_self.val()=='G2'||_self.val()=='G5'){
