var main = function(){
    controller = "index.php/P_kasus_remedial_G2";
    ...
    //                console.log(settings);
                ...
                success:function(response){
                    ...
                    if(obj)//if json data
                    {
                        ...
                        if(obj.status === 1){
                            ...
                            $('form#form_dpk div[name="kr"]').html(obj.penanganan);
                            $('form#form_dpk input[name="pkrl"]').val(obj.pk_l);
                            $('form#form_dpk div[name="pr"]').html(obj.pelaksana);
                            $('form#form_dpk input[name="prl"]').val(obj.pl_l);
                            $('form#form_dpk input[name="tmpt"]').val(obj.tempat);
                            $('form#form_dpk input[name="inp_wp"]').val(obj.tanggal);
                            $('form#form_dpk input[name="inp_to"]').val(obj.to_tgl);
                            $('form#form_dpk div[name="juml"]').html(obj.jumlah);
                            $('form#form_dpk input[name="jkr_l"]').val(obj.jk_l);
       ...
       $(".wrapper_penanganan").on('click', '.inp_kr_penanganan', function(e){
            //alert();
            $(".penangan_div").hide();
            if (this.value == '4') {
                    $(".penangan_div").show();
        ...
        $(".wrapper_pelaksana").on('click', '.inp_r_pelaksana', function(e){
            $(".pelaksana_div").hide();
            if (this.value == '5') {
                    $(".pelaksana_div").show();
            }
        });
         $(".wrapper_jml").on('click', '.inp_r_jml', function(e){
