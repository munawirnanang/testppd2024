var main = function(){
    controller = "index.php/Rujukan_polkor_G2";
    ...
    //                console.log(settings);
                ...
                success:function(response){
                    ...
                    if(obj)//if json data
                    {
                        ...
                        if(obj.status === 1){
                            ...
                            $('form#form_dpk input[name="inp_wp"]').val(obj.tgl_kasus);
                            $('form#form_dpk input[name="tempat"]').val(obj.tempat);
                            $('form#form_dpk div[name="pbkasus"]').html(obj.rujukan);
       ...
       $('input[type=radio][name=rk]').change(function(e) {           
            e.preventDefault();
            $(".rujukan_div").hide();
            if (this.value == '4') {
                    $(".rujukan_div").show();
