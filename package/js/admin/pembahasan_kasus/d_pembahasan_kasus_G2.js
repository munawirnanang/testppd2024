var main = function(){
    controller = "index.php/D_pembahasan_kasus_G2";
...
//                            $('form#form_dpk input[name="inp_jam"]').val(obj.data_dpk[0].waktu);
//                            $('form#form_dpk input[name="peserta"]').val(obj.data_dpk[0].peserta);
...
//                            $('form#form_add_dtm div[name="jwb"]').html(obj.jawaban);
       ...
       form_dpk.validate({
            ...
            rules:{
                ...
                inp_tm:{required:true},
                peserta:{required:true},
                penjelasan:{required:true}                
            },
