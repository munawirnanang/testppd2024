var main = function(){
    controller = "index.php/D_penanganan_kasus_G2";
    ...
    //                console.log(settings);
       ...
       table.on('click', 'a.detail', function(e){
                ...
                success:function(response){
                    ...
                    if(obj)//if json data
                    {
                        ...
                        if(obj.status === 1){
                            ...
                            $('form#form_dpk input[name="alru"]').val(obj.alasan);
                            $('form#form_dpk input[name="rekom"]').val(obj.rekom);
        ...
        $(".wrapper_rujuk").on('click', '.inp_rd_rujuk', function(e){
            //alert();
            $(".rujukan_div").hide();
            if (this.value == '4') {
                    $(".rujukan_div").show();
...
//       $('input[type=radio][name=krk]').change(function(e) {           
//            e.preventDefault();
//                zalert('');
//            $(".rujukan_div").hide();
//            if (this.value == '4') {
