var main = function(){
    controller = "index.php/Data_demografi_G2";
                ...
                success:function(response){
                    ...
                    if(obj)//if json data
                    {
                        ...
                        if(obj.status === 1){
                            ...
                            $('form#form_edit input[name="name"]').val(obj.data[0].keldes+", "+obj.data[0].nm_kec+", "+obj.data[0].nm_kabko+", "+obj.data[0].nama_pro);
...
//                                loading.hide();
        ...
        $("#oras").change(function(e){
             e.preventDefault();
             var self = $('.checkbox:checked').val("");
            //var _self = $(this);
            $(".hidden_ormas").hide();
            if(self.val()=='Y'){
                $(".hidden_ormas").show()();
        ...
        form_e.validate({
            ...
            errorClass: 'help-block help-block-error', // default input error message class
            rules:{
                id:{required:true}, code:{required:true}, name:{required:true}, name_kab:{required:true}, name_kec:{required:true}, name_kel:{required:true}, rt:{required:true}, rw:{required:true},
                manula_lk:{required:false},
                manula_pr:{required:false},
                dewasa_lk:{required:false},
                dewasa_pr:{required:false},
                anak_lk:{required:false},
                anak_pr:{required:false},
                pns:{required:false},
                petani:{required:false},
                nelayan:{required:false},
                wiraswasta:{required:false},
                lain:{required:false},
                pasard:{required:false},
                pskk:{required:false},
                kantordesa:{required:false},
            },
