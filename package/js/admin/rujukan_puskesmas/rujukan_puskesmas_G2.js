var main = function(){
    controller = "index.php/Rujukan_puskesmas_G2";
    ...
    //                console.log(settings);
                ...
                success:function(response){
                    ...
                    if(obj)//if json data
                    {
                        ...
                        if(obj.status === 1){
                            ...
                            $('form#form_ch p[name="eko"]').html(obj.ekon);
                            ...
                            $('form#form_dpk input[name="tmpt"]').val(obj.tempat);
                            $('form#form_dpk div[name="pbkasus"]').html(obj.kasus);
                            $('form#form_dpk input[name="nm_pengaju"]').val(obj.nama_pengaju);
                            $('form#form_dpk input[name="nm_penerima"]').val(obj.nama_penerima);
                            $('form#form_dpk div[name="jlp_diberikan"]').html(obj.jenis_layanan);
                            $('form#form_dpk input[name="puskesmas_lain"]').val(obj.jenis_lain);
                            $('form#form_dpk div[name="stsakhir"]').html(obj.status_akhir);
                            
                            //$('form#form_dpk input[name="termin"]').val(obj.termin);
       ...
       $(".wrapper_jenis").on('click', '.inp_rd_jenis', function(e){
            $(".rujukan_div").hide();
            if (this.value == '4') {
                    $(".rujukan_div").show();
            }
        ...
        $(".status_akhir").on('click', '.inp_rd_status', function(e){
            $(".hidden_termin").hide();
            if (this.value == '2') {
                    $(".hidden_termin").show();
            }
