var main = function(){
    controller = "PPD8_M_Dokumen_Daerah";
    var datatable = function(){
        
        var twlyh = $("#t_wlyh");
        

        $("#list_dokumen").on("click", function(e){

            loading.show();
            ajax_url = controller+"/g_dokumen_all";
            jQuery.ajax({
                type: "GET",
                ...
                success:function(response){
                    ...
                    if(obj){
                        ...
                        if(obj.status === 1){
                            $("#tabel_dokumen_all > tbody").html(obj.str);
                            $('#tabel_dokumen_all').DataTable();
                            loading.hide();
        ...
        twlyh.on("click","a.getDetail",function(e){
            ...
            $("._wrapper_bahan").show();
            $("._wrapper_wlyh").hide();
            $(".lbl_hdr_katewlyh").html("Provinsi").show();
            $(".lbl_hdr_nmwlyh").html(lblpkk).show();
            g_bahan();
        });
        ...
        $("#btnDowDocAll").click(function(){
            window.open(base_url+controller+"/d_bahan_all"); 
        });
