var main = function(){
    controller = "index.php/M_users_tpitpu";
...
//                     { "width": "80px", "targets": 2}                     
     ...
     //                console.log(settings);
        ...
        $("#list_kab").on('click', '#save_popup', function(e){
            ...
            var tahap = $('form#form_kk select[name="tahapkab"]').val();
            loading.show();
             ajax_url = controller+"/add_kk";
             ajax_data="id="+$("#inp_user").val()+"&kk="+idkk+"&tahap="+tahap;
             ajax_data+="&"+csrf_name+"="+$("#csrf").val();
             //alert(ajax_data);
