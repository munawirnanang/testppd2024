var main = function(){
    controller = "index.php/M_users_kabkota";
...
//                     { "width": "80px", "targets": 2}                     
                 ...
                 "lengthMenu": [[5, 20, 25, 50, 100], [5, 20, 25, 50, "All"]],
     ...
     //                console.log(settings);
        ...
        $("#rekap_active_user").click(function(e){
            window.open(base_url+controller+"/rekap_active_user"); 
        });
        ...
        $("#lprov").change(function(e){
            e.preventDefault();
            var _self = $(this);
            var idprov = _self.val();
            ajax_url = controller+"/list_kab";
            ajax_data="idprov="+idprov;
            ...
            jQuery.ajax({
                ...
                success:function(response){
                    ...
                    if(obj)
                    {
                        ...
                        if(obj.status === 1){
                            loading.hide();
                            $('#t_dataKab select[name="lkab"]').html(obj.str);
                        }
                        else{
                    ...
                    success:function(response){
                        ...
                        if(obj)//if json data
                        {
                            ...
                            if(obj.status === 1){
                                ...
                                datatable.ajax.reload();
                                //forml[0].reset();
                                $('.table_wilayah').html(obj.tbl_wilayah);
                                toastr.options = {
                                  "closeButton": false,
                                  "debug": false,
                                  "newestOnTop": false,
