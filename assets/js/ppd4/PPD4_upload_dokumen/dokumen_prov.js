       ...
       frmDokumenAdd.validate({
                ...
                jQuery.ajax({
                    ...
                    success:function(response){
                        ...
                        if(obj)
                        {
                            $("#csrf").val(obj.csrf_hash);
                            if(obj.status === 1){
                                console.log('satker : '+obj.satker);
                                console.log('inp_nm : '+obj.inp_nm);
        ...
        frmDokumenInovasiAdd.validate({
           ...
           rules:{
            ...
            submitHandler: function(form) {
                var url = controller+"/save_dokumen_prov_inovasi";
