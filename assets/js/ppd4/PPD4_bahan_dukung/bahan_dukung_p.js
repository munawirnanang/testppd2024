var main = function(){
    controller = "PPD4_dokumen";
    var datatable = function(){
        
        var table   = $("#dataUser");
        var t_bahan = $("#t_bahan_dukung");
...
//            $("._wrapper_bahan").show();
        ...
        t_bahan.on('click', 'a._btnDokDel', function(e){
            e.preventDefault();
            var _self   = $(this);
            var id      = _self.data('id');
        ...
        t_bahan.on("click","a._btnEdtDok",function(){
            var _self       = $(this);
            var id      = _self.data('id');
            var nmdok   = _self.data('title');
            
            $('form#frmDokEdt input[name="nama"]').val(nmdok);
            $('form#frmDokEdt input[name="iddok"]').val(id);
