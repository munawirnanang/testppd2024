var main = function(){
    controller = "PPD4_M_Penilaian_Prov_Daerah";
    var datatable = function(){
       ...
       table.on("click","a.getDetail",function(e){
        ...
        frmDokAdd.validate({
            ...
            rules:{
                nama:{required:true},
                attch:{extension: "doc|docx|pdf|xlsx|xls|csv|mp4|png|jpg|jpeg|zip|ZIP|pptx|ppt|rar|RAR|avi|",filesize: 30000000000}, //3 mb
            },
        ...
        t_bahan.on("click","a.btnUp",function(e){
            var _self       = $(this);
            var id       = _self.data("id");
            var iddok    = _self.data("iddok");
            var lbnm     = _self.data("nama");
            $("#inp_iddok").val(iddok);
            $("#inp_dok").val(id);
            $("#namaup").val(lbnm);
            $("._wrapper_info").hide();
            $('#mdl_dok_up').modal('show');
        });

        var frmDokUp = $("#frmDokUp");
        frmDokUp.validate({
            errorElement: 'span',
            errorClass: 'error', 
            rules:{
                iddok:{required:true},
                nama:{required:true},
                attch:{extension: "doc|docx|pdf|xlsx|xls|csv|mp4|png|jpg|jpeg|zip|pptx|ppt|rar|avi|",filesize: 300000000}, //3 mb
            },
            errorPlacement: function(error, element) {
                if (element.attr("name") === "pagu_bansos" 
                        || element.attr("name") === "pagu_bm" 
            ...
            submitHandler: function(form) {
                var url = controller+"/save_dok_prov_d_up";
                var data1 = new FormData(frmDokUp[0]);
        ...
        frmDokEdt.validate({
            ...
            rules:{
                nama:{required:true},
                filedok:{extension: "doc|docx|pdf|xlsx|xls|csv|mp4|png|jpg|jpeg|zip|pptx|ppt|rar|avi|",filesize: 300000000}, //3 mb
            },
            errorPlacement: function(error, element) {
                if (element.attr("name") === "pagu_bansos" 
                        || element.attr("name") === "pagu_bm" 
