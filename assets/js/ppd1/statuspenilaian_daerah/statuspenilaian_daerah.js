var main = function(){
    ...
    var datatable = function(){
        ...
        var t_bahan = $("#t_bahan");
        var t_bahan_kabkot = $("#t_bahan_kabkot");
                ...
                success:function(response){
                    ...
                    if(obj)
                    {
                        ...
                        if(obj.status === 1){
                            ...
                            $("#t_bahan_kabkot > tbody").html(obj.str);
        ...
        t_bahan_kabkot.on("click","a.getDetail",function(e){
            var _self       = $(this);
            var id        = _self.data("id");
            var lblkk     = _self.data("nmkk");
            $("#inp_wlyh").val(id);
 ...
 //                            $("._wrapper_info").show();
        ...
        $(".btnShwHd").click(function(){
            ...
            if(_reload=='kabko'){
               ...
               $(".stepper-status-penilaian-kabupaten-tpt").show();
