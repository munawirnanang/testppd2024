    ...
    <div class="row" style="margin-top: 90px;">
        <div class="col-12">
            <div class="card" style="border: 1px solid rgba(49, 126, 235, 1); min-height: 125px;">
                ...
                <div class="card-body">
                    <div class="text-left">
                        <p class="mb-0"><b>Penilaian</b> &nbsp;: Modul 3 Verivikasi</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <!-- <li class="nav-item">
                                <a class="nav-link" id="message-tab" data-toggle="tab" href="#message" role="tab" aria-controls="message" aria-selected="false">
                                    <span class="d-block d-sm-none"><i class="mdi mdi-email-outline font-18"></i></span>
                                    <span class="d-none d-sm-block span-persandingan-penilaian">Persandingan penilaian Skor Item Tahap III per Daerah yang Dinilai <span class="badge badge-secondary">New Feature</span></span>
                                </a>
                            </li> -->
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered " id="t_item">
                                        <thead>
                                            <tr class="bg-primary text-white">
                                                <th class="text-uppercase text-vertical-center" title="No Urut">
                                                    <center>NO</center>
                                                </th>
                                                <th class="text-uppercase text-vertical-center">
                                                    <center>Item Penilaian</center>
                                                </th>
                                                <th class="text-uppercase text-vertical-center">
                ...
                <div class="card card-color mb-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="field-1" class="control-label">Keunggulan <span class="text" id="lbl_jdl_aspek"></span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="field-1" class="control-label">Rekomendasi <span class="text" id="lbl_jdl_aspek"></span></label>
