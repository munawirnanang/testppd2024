<div class="container-fluid">
            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="breadcrumb-item active">Unduh Nilai</li>
                    </ol>
                </div>
        ...
        <div class="col-12" style="background-color: #f1f1f1; position: fixed; z-index: 98; border-bottom: 1px solid rgba(49, 126, 235, 0.3); margin-top: 5px;">
            <div class="page-title-box" style="padding: 10px 0px 0px 20px; margin: 0px;">
                ...
                <div style="display: flex;">
                    <div class="card" style="color: #d1d1d1; border: 2px solid #d1d1d1; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
                        <div class="card-body" style="padding: 2px 8px;">
                            <p class="mb-0">List Kabupaten <i class="mdi mdi-numeric-1-box-outline" style="color: #d1d1d1;"></i></p>
                        </div>
                    </div>
    ...
    <div class="row _wrapper _wrapper_wlyh" style="margin-top: 90px; display: block;">
        ...
        <p class="text-muted font-13 mb-4">Silahkan klik <strong style="color: #317eeb;">unduh nilai</strong> pada <strong>kabupaten</strong> yang dipilih.</p>

        <div class="row" style="display: flex; justify-content: center;">
            <div class="col-lg-10" id="t_wlyh"> </div>
        </div>
    </div>
...
<!--    <div class="row _wrapper _wrapper_prov" style="display: none">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">List Provinsi</h3>
                </div>
                <div class="card-body">
