<div class="container-fluid">
                ...
                <div style="display: flex;">
                    <div class="card" style="color: #d1d1d1; border: 2px solid #d1d1d1; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
                        <div class="card-body" style="padding: 2px 8px;">
                            <p class="mb-0">List Kota <i class="mdi mdi-numeric-1-box-outline" style="color: #d1d1d1;"></i></p>
                        </div>
                    </div>
    ...
    <div class="row _wrapper _wrapper_wlyh" style="margin-top: 90px; display: block;">
        ...
        <p class="text-muted font-13 mb-4">Silahkan klik <strong style="color: #317eeb;">unduh nilai</strong> pada <strong>Kota</strong> yang dipilih.</p>
