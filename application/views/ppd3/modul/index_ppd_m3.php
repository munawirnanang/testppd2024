        ...
        <div class="row" style="margin-top: 90px;">
            <div class="col-12">
                <div class="card" style="border: 1px solid rgba(49, 126, 235, 1); min-height: 125px;">
                    ...
                    <div class="card-body">
                        <div class="text-left">
                            <p class="mb-0"><b>Penilaian</b> &nbsp;: Modul 3 Verifikasi</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row _wrapper _wrapper_indi" style="display: none">
        ...
        <div class="row" style="margin-top: 90px;">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listt Indikator</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row" style="display: flex; justify-content: end;">
                            ...
                            <div class="col-md-2">
                                <div class=" p-1 text-vertical-center text-center" style="float: right;border:3px solid #e8e8e8;box-shadow: 5px 10px #b6b6b6;">
                                    <p>Nilai :</p>
                            ...
                            <table class="table table-bordered table-hover" id="t_item">
                                <thead>
                                    <tr class="bg-primary text-white">
                                        <th class="text-uppercase text-vertical-center" title="No Urut" ><center>NO</center></th>
                                        <th class="text-uppercase text-vertical-center" ><center>Item Penilaian</center></th>
                                        <th class="text-uppercase text-vertical-center" ><center>Sumber Informasi</center></th>
                                        <th class="text-uppercase text-vertical-center" ><center>SKOR</center></th>
                                    </tr>
