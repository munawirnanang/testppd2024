    ...
    <!-- <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title text-center text-secondary" >Tahap 2 - Dokumen Daerah</h4>
            ...
            <div class="col-12">
                <div class="card" style="border: 1px solid rgba(49, 126, 235, 1); min-height: 125px;">
                   <!-- <div class="avatar-lg bg-info rounded-circle mr-2" style="position: absolute; height: 5.5rem; width: 5.5rem; top: 20px; right: 15px; background-color: rgba(49, 126, 235, 0.2) !important; border: 2px solid rgba(41,182,246, 0.5)">
                    ...
                    <div class="card-body">
                        <div class="text-left">
                            <p class="mb-0"><b>Penilaian</b> &nbsp;: Modul 2 Presentasi Dan Wawacara</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row _wrapper _wrapper_wlyh" style="display: none">
        ...
        <div class="row" style="margin-top: 90px; display: block;">
            ...
            <div class="row" style="display: flex; justify-content: center;">
                <!-- <p class="text-muted font-13 mb-4">Sebelum melakukan penilaian, silahkan mengunduh <strong style="color: #317eeb;">dokumen daerah</strong>.</p> -->
                <input type="hidden" id="inp_kate_wlyh" value=""/>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="card card-color mb-0">
                ...
                <div class="card-body">
                    <h3 class="card-title mt-1 mb-1" style="color: black;">Dokumen Daerah - Tahap 2 - <span class="lbl_jdl_wlyh"></span></h3>
                    <p class="text-muted font-13 mb-4">Silahkan unduh dokumen-dokumen dibawah sebelum melakukan penilaian</p>
                    <input type="hidden" id="inp_kode_wlyh" value=""/>
                    <div class="row">
                        <div class="col-12">
