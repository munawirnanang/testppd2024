    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title text-center text-secondary" >Upload Penilaian - Tahap 2</h4>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Upload Dokumen Penilaian - Tahap 2</h5>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <span class="text-info" style='font-size: 10px'>Format: Nama Dokumen (spasi) Daerah. </span>
                                    <span class="text-info" style='font-size: 10px'>Contoh : Tahap 2 Provinsi A</span>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <span class="text-info" style='font-size: 10px'>Format: Nama Dokumen (spasi) Tahun (spasi) Daerah. </span>
                                    <span class="text-info" style='font-size: 10px'>Contoh : RKPD 2020 Kabupaten A</span>
                                <input type="text" class="form-control" id="field-3" name="nama" placeholder="" required="">
                            </div>
                        </div>
