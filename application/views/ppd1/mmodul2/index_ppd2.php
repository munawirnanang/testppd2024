    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title text-center text-secondary" style="font-family: inherit" >MANAJEMEN DATA MODUL II</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb p-0 m-0">
                        <li class="breadcrumb-item"><a href="#">Manajemen Data</a></li>
                        <li class="breadcrumb-item active">Modul II</li>
                    </ol>
                </div>
...
<!--                    <button class="btn btn-info" id="btnShwMdlKriteriaAdd"><i class="fas fa-plus"></i>&nbsp;Data Baru Kriteria</button>-->
                    <button class="btn btn-info" id="btnShwMdlIndiAdd"><i class="fas fa-plus"></i>&nbsp;Data Baru Indikator</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row _wrapper _wrapper_sindi" style="display:none">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title pull-left">List Dinilai</h3>
                </div>
                <div class="card-body">
<!--                    <input type="hidden" id="inp_indi" value=""/>-->
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="t_ijudul">
                            <thead>
                                <tr>
                                    <th class="" title="No Urut">NO</th>
                                    <th class="text-uppercase">Item Dinilai</th>
                ...
                <div class="card-footer">
                    <button class="btn btn-info" id="btnShwMdlJindiAdd"><i class="fas fa-plus"></i>&nbsp;Data Baru</button>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
...
<form id="frmKriteriaAdd">
    <div id="mdl_kriteria_add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
                                <label for="field-1" class="control-label">Aspek</label>
                                <select class="form-control" id="field-1" name="kriter"  required="">
                                    <option value="">- Pilih -</option>
                                    <?php
                                    foreach ($list_aspek->result() as $v) {
                                        ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="field-3" class="control-label">Nama Kriteria</label>
...
<form id="frmJitemAdd">
    <div id="mdl_jitem_add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Item Dinilai</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="field-3" class="control-label">Nama Item Dinilai <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="field-3" name="nama" placeholder="" required="">
                            </div>
                        </div>
...
<form id="frmJitemEdit">
    <div id="mdl_jitem_edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                        <h5 class="modal-title">Ubah Data Item Dinilai</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
