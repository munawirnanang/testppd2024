<div class="container-fluid">
    <!-- <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title text-center text-secondary" >Bahan Dukung Penilaian Dokumen</h4>
    ...
    <div class="row _wrapper _wrapper_wlyh" style="display: block;">
                    ...
                    <div style="display: flex;">
                        <div class="card" style="color: white; border: 2px solid white; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
                            <div class="card-body" style="padding: 2px 8px;">
                                <p class="mb-0">Daftar Daerah <i class="mdi mdi-numeric-1-box-outline" style="color: white;"></i></p>
                            </div>
                        </div>
                        <div class="card" style="color: black; border: 2px solid #d1d1d1; border-style: dashed; background-color: #f1f1f1; margin-bottom: 15px; margin-right: 1%;">
                            <div class="card-body" style="padding: 2px 8px;">
                                <p class="mb-0" style="color: #d1d1d1;">Daftar Dokumen Daerah <i class="mdi mdi-numeric-2-box" style="color: #d1d1d1;"></i></p>
                            </div>
                        </div>
        ...
        <div class="row" style="margin-top: 90px;">
            <div class="col-lg-12">
                <p class="text-muted font-13 mb-4">Silahkan pilih <strong>provinsi</strong> dan klik <strong style="color: #33b86c;">detail</strong> untuk melihat <strong>file / dokumen daerah</strong>.</p>

                <div class="row" style="justify-content: right;">
                    <button type="button" class="btn btn-info waves-effect waves-light mb-3" style="margin-right: 100px; border-radius: 0px;" id="list_dokumen" data-toggle="modal" data-target=".bs-example-modal-lg">List Dokumen</button>
                </div>
                ...
                <!-- <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Bahan Dukung Penilaian Dokumen Provinsi</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered table-hover" id="t_wlyh">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text">Nama Provinsi</th>
                                    </tr>
                    ...
                    <div style="display: flex;">
                        <div class="card" style="color: black; border: 2px solid rgba(49, 126, 235, 1); border-style: dashed; background-color: white; margin-bottom: 15px; margin-right: 1%;">
                            <a href="#" class="btnShwHd" data-show="._wrapper" data-hide="._wrapper_bahan,._wrapper_info" data-hdrhide=".lbl_hdr_nmwlyh" data-reload="prov">
                                <div class="card-body" style="padding: 2px 8px;">
                                    <p class="mb-0">Daftar Provinsi <i class="mdi mdi-numeric-1-box" style="color: #d1d1d1;"></i></p>
                                </div>
                            </a>
                        </div>
                        <div class="card" style="color: white; border: 2px solid white; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
                            <div class="card-body" style="padding: 2px 8px;">
                                <p class="mb-0">Daftar Dokumen Daerah <i class="mdi mdi-numeric-2-box-outline" style="color: white;"></i></p>
                            </div>
                        </div>
                        <a href="#" class="btnShwHd" data-show="._wrapper" data-hide="._wrapper_bahan,._wrapper_info" data-hdrhide=".lbl_hdr_nmwlyh" data-reload="prov">
                    ...
                    <div class="card-body">
                        <div style="overflow-x: auto;">
                            <table class="table-description table-modified">
                                ...
                                <tr style="">
                                    <td  class="text lbl_hdr_katewlyh"></td>
                                    <td>:</td>
        ...
        <div class="col-lg-12" style="padding: 0px;">
            <div class="card">
                <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 5px;">
                    <h3 class="card-title">Daftar Dokumen Daerah</h3>
                ...
                <div class="card-body" style="padding-top: 0px;">
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-hover" id="t_bahan" style="border: 1px solid black; margin-bottom: 0px; border-collapse: inherit;">
                            <thead style="background-color: rgb(31, 56, 100) !important; color: white;">
                                <tr>
                                    <th class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;">
                                        <center>NO</center>
                                    </th>
                                    <th class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <button class="btn btn-sm btn-primary waves-effect waves-light" id="btnDowDocAll" style="border-radius: 0px; padding-left: 10px; padding-right: 10px;margin-right: 5px; margin-bottom: 10px; float: right;">Unduh Semua <i class="fas fa-download" style="padding-left: 5px;"></i></button>
                <h3 class="card-title mt-1 mb-1" style="color: black;">List Dokumen</h3>
                <hr>
                <table id="tabel_dokumen_all" class="table table-condensed table-bordered table-striped" style="border: 1px solid black; border-collapse: separate !important; border-spacing: 1.5px; width: 100%;">
                    <thead style="background-color: rgb(31, 56, 100) !important; color: white;">
                        <tr>
