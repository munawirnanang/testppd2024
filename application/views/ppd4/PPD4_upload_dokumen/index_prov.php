    ...
    <!-- <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title text-center text-secondary" style="font-family: inherit" >Dokumen Pendukung Provinsi</h4>
        ...
        <div class="col-lg-12">
            <div class="card card-color mb-0">
                <div class="card-header bg-light" style="background: url(<?php echo base_url(); ?>/assets/icons/bg_modal_5.jpg) no-repeat center center; background-size: cover; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover;">
                    <!-- <h3 class="card-title text-custom">List Dokumen Pendukung Provinsi</h3> -->
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <!-- <table class="table table-condensed table-bordered table-striped " id="t_bahan_upload" style="border: 1px solid black; margin-bottom: 0px; border-collapse: inherit;"> -->
                        <h3 class="card-title text-custom">Daftar Dokumen Pendukung Provinsi</h3>
                ...
                <div class="card-footer" style="padding-top: 0px;">
                    ...
                    <!-- <button class="btn btn-info " id="btnShwMdlSindiAdd" style="border-radius: 0px; padding-left: 10px; padding-right: 10px;margin-right: 5px; margin-bottom: 10px; float: right;"><i class="fas fa-plus"></i>&nbsp;Data Baru</button> -->
                </div>
            </div>
        </div>
    </div>

    <div class="row _wrapper _wrapper_upload" style="display: none">
        <div class="col-lg-12">
            <div class="card card-color mb-0">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <label for="field-3" class="control-label">File RKPD<span class="text-danger">*</span></label>
                                <div class="col-md-5 input-group">
                                    <input type="file" class="form-control" id="field-3" name="attch" placeholder="" required="">
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-info waves-effect waves-light"><i class="fas fa-save"></i>&nbsp;Upload</button>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="field-3" class="control-label">File RPJMD<span class="text-danger">*</span></label>
                                <div class="col-md-5 input-group">
                                    <input type="file" class="form-control" id="field-3" name="attch2" placeholder="" required="">
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-info waves-effect waves-light"><i class="fas fa-save"></i>&nbsp;Upload</button>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="field-5" name="deskripsi" rows="4" cols="50" maxlength="3000" placeholder="Penjelasan singkat terkait inovasi" placeholder="Contoh: Inovasi pertanian dengan menggunakan AI" required="" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
