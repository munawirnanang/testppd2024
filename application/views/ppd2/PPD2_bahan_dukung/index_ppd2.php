                    ...
                    <div style="display: flex;">
                        <div class="card" style="color: white; border: 2px solid white; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
                            <div class="card-body" style="padding: 2px 8px;">
                                <p class="mb-0">Daftar Provinsi <i class="mdi mdi-numeric-1-box-outline" style="color: white;"></i></p>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-hover" id="t_bahan" style="border: 1px solid black; margin-bottom: 0px; border-collapse: inherit;">
                            <thead style="background-color: rgb(31, 56, 100) !important; color: white;">
                                <tr>
                                    <th class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center>NO</center></th>
                                    <th class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center>Nama Dokumen</center></th>
                                    <th class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center>Diupload Oleh</center></th>
                                    <th class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center>Aktivitas</center></th>
                                    <th class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center>Unduh</center></th>
                                </tr>
                            </thead>
                            <tbody>
