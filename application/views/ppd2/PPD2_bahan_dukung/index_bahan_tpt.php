    ...
    <!-- <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title text-center text-secondary" style="font-family: inherit" >Daftar Bahan Pendukung Penilaian </h4>
                <div class="page-title-right">
                    <ol class="breadcrumb p-0 m-0">
                        <li class="breadcrumb-item"><a href="#">Beranda</a></li>
                        <li class="breadcrumb-item"><a href="#">Bahan Dukung</a></li>
        ...
        <div class="row" style="margin-top: 90px;">
            <div class="col-lg-12">
                ...
                <!-- <div class="card-header">
                        <h3 class="card-title">daftar bahan pendukung penilaian Tahap 2</h3>
                    </div> -->
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            <div class="alert alert-info alert-dismissible fade show">
                                ...
                                <i class="fa fa-info-circle "></i> Silahkan unduh dokumen-dokumen dibawah sebelum melakukan penilaian.
                            </div>
                        </div>
                        ...
                        <table class="table table-condensed table-bordered table-striped " id="t_bahan" style="border: 1px solid black; margin-bottom: 0px; border-collapse: inherit;">
                            <thead style="background-color: rgb(31, 56, 100) !important; color: white;">
                                <tr>
                                    <td class="text" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center><b>No</b></center></td>
                                    <td class="text" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center><b>Nama Dokumen</b></center></td>
                                    <td class="text" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center><b>Diupload Oleh</b></center></td>
                                    <td class="text" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center><b>Aktivitas</b></center></td>
                                    <td class="text" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center><b>Unduh</b></center></td>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
                            ...
                            <table class="table table-condensed table-bordered table-striped" id="t_bahan">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text" style="width:10px">Diupload Oleh</th>
                                        <th class="text" style="width:10px">Aktivitas</th>
                                        <th class="text" style="width:5px">Tautan</th>
                                    </tr>
                                </thead>
                                <tbody>
