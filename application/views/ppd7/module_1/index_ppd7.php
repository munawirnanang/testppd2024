        ...
        <div class="modal-content">
            <div class="card card-color mb-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="card-title mt-1 mb-4" style="color: black;">Lembar Pernyataan <span class="lbl_jdl_wlyh"></span></h3>
                            <hr/>
                            <div class="form-group" style="margin-bottom: 0px;">
                                ...
                                <div class="row">
                                    <div class="d-flex">
                                        ...
                                        <!-- <a href="" id="btn_sttmntUnduhLink" download="<?php echo str_replace(' ','_',$username)?>_kertas_kerja" target="_blank" title="Klik untuk unduh data" class="btn btn-xs btn-primary waves-effect waves-light" style="border-radius: 0px; padding-left: 10px; padding-right: 10px; margin-left: 13px;">Unduh Lembar Kerja <i class='fas fa-download' style='padding-left: 5px;'></i></a> -->
