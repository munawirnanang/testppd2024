<div class="container-fluid">
    ...
    <div class="row _wrapper _wrapper_wlyh" style="display: block;">
        ...
        <div class="row" style="margin-top: 90px;">
            <div class="col-lg-12">
                <p class="text-muted font-13 mb-4">Silahkan pilih <strong>kabupaten</strong> dan klik <strong style="color: #33b86c;">detail</strong> untuk melihat <strong>file / dokumen daerah</strong>.</p>
                ...
                <!-- <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Bahan Dukung Penilaian Dokumen Kabupaten</h3>
                    </div>
                    <div class="card-body">
