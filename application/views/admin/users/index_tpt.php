<div class="container-fluid">
                ...
                <div style="display: flex;">
                    <div class="card" style="color: white; border: 2px solid white; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
                        <div class="card-body" style="padding: 2px 8px;">
                            <p class="mb-0">Manajemen User TPT <i class="mdi mdi-numeric-1-box-outline" style="color: white;"></i></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <!-- <div class="col-md-6 col-xl-6">
                            <div class="card-box" style="background-color: aqua;">
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <div class="text-right">
                                            <h4 class="font-20 my-0 font-weight-bold"><span data-plugin="counterup" id="active_user">15852</span>/<span data-plugin="counterup" id="total_user">15852</span></h4>
                                            <p class="mb-0 mt-1 text-truncate">Pengguna Aktif</p>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- <div class="row _edituser" style="display: none; margin-top: 90px;">
                ...
                <div style="display: flex;">
                    <div class="card" style="color: black; border: 2px solid rgba(49, 126, 235, 1); border-style: dashed; background-color: white; margin-bottom: 15px; margin-right: 1%;">
                        <a href="#" class="btnShwHd" data-show="._list_user" data-hide="._wrapper_info" data-hdrhide=".lbl_hdr_nmwlyh" data-reload="DUser">
                            <div class="card-body" style="padding: 2px 8px;">
                                <p class="mb-0">Manajemen User TPT <i class="mdi mdi-numeric-1-box" style="color: #d1d1d1;"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="card" style="color: white; border: 2px solid white; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
        ...
        <div class="col-lg-12" style="margin-top: 90px;">
            <div class="card" style="border: 1px solid rgba(49, 126, 235, 1);">
                ...
                <div class="card-header border-info bg-transparent pb-0">
                    <h3 class="card-title text-info">Profil TPT</h3>
                </div>
                <div class="card-body">
                    <div class="text-left">
                        ...
                        <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="card list_prov" style="">
                                <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 5px;">
                                    ...
                                    <button data-toggle="modal" data-target="#modal_wil" class="btn btn-info waves-effect waves-light" style="border-radius: 0px; padding-left: 10px; padding-right: 10px;margin-right: 5px; margin-bottom: 10px; float: right;"><i class="fa fa-plus"></i> Tambah Data</button>
                                </div>
                        ...
                        <div class="tab-pane show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="card list_kabkota" style="">
                                <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 5px;">
                                    ...
                                    <button data-toggle="modal" data-target="#modal_add_kab" class="btn btn-info waves-effect waves-light" style="border-radius: 0px; padding-left: 10px; padding-right: 10px;margin-right: 5px; margin-bottom: 10px; float: right;"><i class="fa fa-plus"></i> Tambah Data</button>
                                </div>
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-12">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="card-title mt-1 mb-1" style="color: black;">Tambah Data User TPT</h3>
                    <hr>
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
    ...
    <div id="modal_edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="card-title mt-1 mb-1" style="color: black;">Edit Data User TPT</h3>
                    <hr>
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" multiple="multiple" name="prov[]" data-actions-box="true" data-live-search="true">
                                    <?php
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <select class="form-control selectpicker" data-width="100%" multiple="multiple" name="kk[]" data-actions-box="true" data-live-search="true">
                                ...
                                ?>
                                    <option value="<?php echo encrypt_text($v->id); ?>" data-subtext="<?php echo $v->nama_provinsi ?>"><?php echo $v->id_kab ?> - <?php echo $v->nama_kabupaten ?></option>
                                <?php
                                }
                                ?>
                            </select>
