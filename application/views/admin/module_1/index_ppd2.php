        ...
        <!-- <div class="col-lg-12">
                <div class="card card-border">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12"><p class="text-left"><small><i>*Silakan klik ikon penilaian yang akan diisi</i></small></p></div>
                        </div>
                    </div>
                </div>
        <!-- </div> -->
                            ...
                            <table class="table table-bordered " id="t_item">
                                <thead>
                                    <tr class="bg-primary text-white">
                                        ...
                                        <th class="text-uppercase text-vertical-center" colspan="2"><center>KATEGORI SKOR PER ITEM</center></th>
