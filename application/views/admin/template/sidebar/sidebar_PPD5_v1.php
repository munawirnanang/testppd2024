                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="#" class="waves-effect link_target" data-target="<?php echo site_url("PPD5_M_Dokumen_Kab") ?>">
                            ...
                            <!--                                <li>
                                    <a href="#" class="waves-effect link_target" data-target="<?php echo site_url("PPD5_bahan_dukung") ?>">
                            ...
                            <!--                                <li>
                                    <a href="#" class="waves-effect link_target" data-target="<?php echo site_url("Unavailable_page") ?>">
                                        ...
                                        <span> Pengaturan User (TPTD) </span>
                                    </a>
                                </li>-->
