                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <!-- <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_modul2") ?>">Input Nilai </a></li>
                                    <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_dokumen_t2") ?>">Bahan Dukung </a></li>
                                    <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t2_dokumen_daerah") ?>">Dokumen Daerah </a></li>
                                    <li>
                                        <a href="javascript: void(0);" class="waves-effect">
                                        ...
                                        <ul class="nav-second-level" aria-expanded="false">
                                            <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t2_unduh_nilai_prov") ?>">Provinsi</a></li>
                                            <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t2_unduh_nilai_kab") ?>">Kabupaten</a></li>
                                            <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t2_unduh_nilai_kota") ?>">Kota</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_modul3") ?>">Input Nilai </a></li>
                                    <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_dokumen_t3") ?>">Bahan Dukung </a></li>
                                    <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t3_dokumen_daerah") ?>">Dokumen Daerah </a></li>
                                    <li>
                                        <a href="javascript: void(0);" class="waves-effect">
                                            <span> Unduh Nilai</span>
                                            <span class="menu-arrow"></span>
                                        ...
                                        <ul class="nav-second-level" aria-expanded="false">
                                            <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t3_unduh_nilai_prov") ?>">Provinsi</a></li>
                                            <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t3_unduh_nilai_kab") ?>">Kabupaten</a></li>
                                            <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t3_unduh_nilai_kota") ?>">Kota</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li> -->
                            ...
                            <!--                                <li>
                                    ...
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t2_penilaian") ?>">Tahap 2 </a></li>
                                        <li><a href="javascript:void(0);" class="waves-effect link_target" data-target="<?php echo site_url("PPD3_t3_penilaian") ?>">Tahap 3 </a></li>
                                    </ul>
                                </li>-->
                        </ul>
