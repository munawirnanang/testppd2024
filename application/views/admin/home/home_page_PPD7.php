                        ...
                        <!-- <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Penghargaan Pembangunan Daerah 2021 (TPT) DAERAG</h4>
                        ...
                        <div class="row" style="margin-top: 90px;">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card" style="border: 1px solid rgba(49, 126, 235, 1);">
                                    <div class="avatar-lg bg-info rounded-circle mr-2" style="position: absolute; height: 5.5rem; width: 5.5rem; top: 60px; right: 15px; background-color: rgba(49, 126, 235, 0.2) !important; border: 2px solid rgba(41,182,246, 0.5)">
                                    ...
                                    <div class="card-body" style="padding-top: 10px;">
                                        <div class="text-left">
                                            <p class="mb-0"><b>Penghargaan Pembangunan Daerah 2022 (TPT) DAERAH</b></p>
                                            ...
                                            <p class="mb-0"><b>Provinsi</b> &nbsp;&nbsp;&nbsp;: <?php echo $satker_name; ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table style="width:100%;  border: 0px solid black" >
                                ...
                                <tr style=" border: 0px solid black">
                                        ...
                                        <td >:</td>
                                        <td style=" border: 0px solid black; font-size: 14px;" name="note"><?php echo $satker_name; ?> </td>
                                </tr>
                            </table>
                                  -->
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card card-border">
                                <div class="card-header border-info bg-transparent pb-0">
                                    <!-- <h3 class="card-title text-info">Card Info</h3> -->
                                </div>
                                <div class="card-body">
