<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title text-center text-secondary" style="font-family: inherit" >Laporan Penilaian</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb p-0 m-0">
                        <li class="breadcrumb-item"><a href="#">Laporan Penilaian</a></li>
    ...
    <div class="row _wrapper_bahan" style="display: none">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">List Dokumen Penilaian</h3>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover" id="t_bahan">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text">Nama Dokumen Penilaian</th>
