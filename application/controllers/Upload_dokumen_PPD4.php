...
class Upload_dukumen_PPD4 extends CI_Controller {
    var $view_dir   = "admin/upload_dokumen/";
    var $js_init    = "main";
    var $js_path    = "assets/js/admin/upload_dokumen/upload_dokumen.js";
    ...
    public function index(){
        if($this->input->is_ajax_request()){
            ...
            {                
                ...
                //common properties
                $this->js_init    = "main";
                $this->js_path    = "assets/js/admin/upload_dokumen/upload_dokumen_".$this->session->userdata(SESSION_LOGIN)->groupid.".js";
