...
class M_users_kabkota extends CI_Controller
{
    ...
    function rekap_user()
    {
        ...
        $this->excel->getSheet(0)->setTitle('Rekap User Tim Kabupaten Kota');
        ...
        header("Content-Disposition:attachment;filename = rekap_user_tim_kabupaten_kota.xls");
    ...
    function rekap_active_user()
    {
        ...
        $this->excel->getActiveSheet()->getSheetView()->setZoomScale(50);
        $this->excel->getSheet(0)->setTitle('Rekap Aktif User Kabupaten Kota');
        ...
        header("Content-Type:application/vnd.ms-excel");
        header("Content-Disposition:attachment;filename = rekap_aktif_user_kabupaten_kota.xls");
        header("Cache-Control:max-age=0");
        $objWriter = PHPExcel_IOFactory::createWriter($this->excel, 'Excel5');
        $objWriter->save("php://output");
    }
