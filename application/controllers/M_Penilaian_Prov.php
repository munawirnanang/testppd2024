...
class M_Pinilaian_Prov extends CI_Controller {
    ...
    public function index(){
        if($this->input->is_ajax_request()){
            ...
            {                
                ...
                //common properties
                $this->js_init    = "main";
                $this->js_path    = "assets/js/admin/penilaian/dokumen_prov.js?v=".now("Asia/Jakarta");
            ...
            try {
                ...
                if($kate_wlyh=="prov"){
                    ...
                    $sql = "SELECT D.`id` mapid, D.judul, D.filename
                            ...
                            WHERE D.provid =? OR D.provid ='-1' AND D.isactive = 'Y' ";
                    $bind = array($idmap);
