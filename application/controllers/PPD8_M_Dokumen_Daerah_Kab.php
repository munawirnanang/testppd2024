 ...
 * date : 10 des 2020
*/
class PPD8_M_Dokumen_Daerah_Kab extends CI_Controller
{
    var $view_dir   = "ppd8/";
    var $js_init    = "main";
    var $js_path    = "assets/js/ppd8/dokumen_daerah_kab.js";
    ...
    public function index()
    {
        if ($this->input->is_ajax_request()) {
            try {
                ...
                $this->js_init    = "main";
                $this->js_tedit    = "main";
                $this->js_path    = "assets/js/ppd8/dokumen_daerah_kab.js?v=" . now("Asia/Jakarta");
        ...
        if ($this->input->is_ajax_request()) {
            try {
                ...
                $sql = "SELECT D.kabid, D.jenisid, D.judul, D.tautan, K.nama_kabupaten, D.cr_by, D.cr_dt
                        ...
                        WHERE D.isactive = 'Y' AND G.groupid = '8' AND K.nama_kabupaten LIKE 'Kabupaten %'
        ...
        if ($this->input->is_ajax_request()) {
            try {
                ...
                $sql = "SELECT 'kab' kate, K.`id` mapid,K.`id_kab` kode,K.`nama_kabupaten` nmprov
                        ...
                        WHERE KGU.groupid=8 AND K.`nama_kabupaten` LIKE 'KABUPATEN %'
                        GROUP BY nmprov ASC";
    ...
    function d_bahan_all()
    {
        ...
        $filename = "dokumen_daerah_kabupaten.zip";
