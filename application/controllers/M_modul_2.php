...
class M_modul_2 extends CI_Controller {
    var $view_dir   = "ppd1/mmodul2/";
    var $js_init    = "main";
    var $js_path    = "assets/js/ppd1/mmodul2/modul.js";
    ...
    public function index(){
        if($this->input->is_ajax_request()){
            try 
            {
                ...
                //common properties
                $this->js_init    = "main";
                $this->js_path    = "assets/js/ppd1/modul2/modul2.js?v=".now("Asia/Jakarta");
                
                $sql = "SELECT id, nama nm FROM `r_mdl2_aspek` WHERE isactive='Y'";
                ...
                $sql = "SELECT id, nama nm FROM r_mdl2_krtria WHERE isactive='Y'";
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                $sql = "SELECT A.id idindi,B.id idkriteria,C.id idaspek,A.`nama` nmindi,A.`bobot` bobotindi,B.`nama` nmkriteria,B.`bobot` bobotkriteria,C.`nama` nmaspek,C.bobot bobotaspek,A.`note` noteindi
                        ...
                        JOIN `r_mdl2_aspek` C ON C.`id` = B.aspekid
    ...
    function save_indi()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id, nama nm FROM r_mdl2_indi WHERE krtriaid=? AND nama=?";
                ...
                // add record
                $this->m_ref->setTableName("r_mdl2_indi");
                $data_baru = array(
                    "krtriaid"  => $inp_kriter,
                    "nama"      => $inp_nm,
                    "bobot"     => $inp_bobot,
    ...
    function delete_indi(){
        if($this->input->is_ajax_request()){
            try {
                ...
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl2_indi WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl2_indi WHERE id=".$id;
...
//                    $str.="<td class='p-l-25'>".wordwrap($v->nmsindi,100,"<br/>")."</td>";
    ...
    function save_dinil()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id,indiid, nama nm FROM `r_mdl2_item_judul` WHERE indiid=?";
                $bind = array($id);
                $list_data= $this->db->query($sql,$bind);
                if(!$list_data){
                    $msg = $session->userid." ".$this->router->fetch_class()." : ".$this->db->error()["message"];
                ...
                // add record
                $this->m_ref->setTableName("r_mdl2_item_judul");
                $data_baru = array(
                    "indiid"    => $id,
                    "nama"      => $inp_nm,
                    "istampil"  => $inp_tampil,
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                if(!is_numeric($id))
                    throw new Exception("Invalid ID");
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl2_item_judul WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl2_item_judul WHERE id=".$id;
    ...
    function save_sindi()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id, nama nm FROM r_mdl2_sub_indi WHERE indiid=? AND nama=?";
                ...
                // add record
                $this->m_ref->setTableName("r_mdl2_sub_indi");
                $data_baru = array(
                    "indiid"    => $id,
                    "nama"      => $inp_nm,
                    "nourut"    => $inp_nourut,
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                if(!is_numeric($id))
                    throw new Exception("Invalid ID");
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl2_sub_indi WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl2_sub_indi WHERE id=".$id;
    ...
    function save_item()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id, nama nm FROM r_mdl2_item WHERE subindiid=? AND nama=?";
                $bind = array($id,$inp_nm);
                $list_data= $this->db->query($sql,$bind);
                if(!$list_data){
                    $msg = $session->userid." ".$this->router->fetch_class()." : ".$this->db->error()["message"];
                ...
                // add record
                $this->m_ref->setTableName("r_mdl2_item");
                $data_baru = array(
                    "subindiid" => $id,
                    "nama"      => $inp_nm,
                    "nourut"    => $inp_nourut,
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                if(!is_numeric($id))
                    throw new Exception("Invalid ID");
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl2_item WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl2_item WHERE id=".$id;
    ...
    function save_indiitem()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id, nama nm FROM r_mdl2_item_indi WHERE itemid=? AND nama=?";
                $bind = array($id,$inp_nm);
                $list_data= $this->db->query($sql,$bind);
                if(!$list_data){
                    $msg = $session->userid." ".$this->router->fetch_class()." : ".$this->db->error()["message"];
                ...
                // add record
                $this->m_ref->setTableName("r_mdl2_item_indi");
                $data_baru = array(
                    "itemid" => $id,
                    "nama"      => $inp_nm,
                    "nourut"    => $inp_nourut,
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                if(!is_numeric($id))
                    throw new Exception("Invalid ID");
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl2_item_indi WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl2_item_indi WHERE id=".$id;
