...
class M_modul_1 extends CI_Controller {
    var $view_dir   = "ppd1/mmodul1/";
    var $js_init    = "main";
        ...
        if($this->input->is_ajax_request()){
            ...
            {                
               ...
               // print_r($current_date_time);exit();
                //common properties
                $this->js_init    = "main";
                $this->js_path    = "assets/js/ppd1/modul2/modul1.js?v=".now("Asia/Jakarta");
                
                $sql = "SELECT id, nama nm FROM r_mdl1_krtria WHERE isactive='Y'";
                ...
                $str = $this->load->view($this->view_dir."index_ppd1",$data_page,TRUE);
    ...
    function g_indi(){
        if($this->input->is_ajax_request()){
            try {
                ...
                //LIST INDIKATOR
                $sql = "SELECT A.id idindi,B.id idkriteria,A.`nama` nmindi,A.`bobot` bobotindi,B.`nama` nmkriteria,B.`bobot` bobotkriteria,A.`note` noteindi
                        ,A.nourut
                        FROM `r_mdl1_indi` A
    ...
    function save_indi()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id, nama nm FROM r_mdl1_indi WHERE krtriaid=? AND nama=?";
                ...
                // add record
                $this->m_ref->setTableName("r_mdl1_indi");
                $data_baru = array(
                    "krtriaid"  => $inp_kriter,
                    "nama"      => $inp_nm,
                    "bobot"     => $inp_bobot,
    ...
    function delete_indi(){
        if($this->input->is_ajax_request()){
            try {
                ...
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl1_indi WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl1_indi WHERE id=".$id;
    ...
    function save_sindi()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id, nama nm FROM r_mdl1_sub_indi WHERE indiid=? AND nama=?";
                ...
                // add record
                $this->m_ref->setTableName("r_mdl1_sub_indi");
                $data_baru = array(
                    "indiid"    => $id,
                    "nama"      => $inp_nm,
                    "nourut"    => $inp_nourut,
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                if(!is_numeric($id))
                    throw new Exception("Invalid ID");
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl1_sub_indi WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl1_sub_indi WHERE id=".$id;
    ...
    function save_item()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id, nama nm FROM r_mdl1_item WHERE subindiid=? AND nama=?";
                $bind = array($id,$inp_nm);
                $list_data= $this->db->query($sql,$bind);
                if(!$list_data){
                    $msg = $session->userid." ".$this->router->fetch_class()." : ".$this->db->error()["message"];
                ...
                // add record
                $this->m_ref->setTableName("r_mdl1_item");
                $data_baru = array(
                    "subindiid" => $id,
                    "nama"      => $inp_nm,
                    "nourut"    => $inp_nourut,
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                if(!is_numeric($id))
                    throw new Exception("Invalid ID");
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl1_item WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl1_item WHERE id=".$id;
    ...
    function save_indiitem()
    {
        if($this->input->is_ajax_request()){
            try {
                ...
                //cek duplikasi
                $sql = "SELECT id, nama nm FROM r_mdl1_item_indi WHERE itemid=? AND nama=?";
                $bind = array($id,$inp_nm);
                $list_data= $this->db->query($sql,$bind);
                if(!$list_data){
                    $msg = $session->userid." ".$this->router->fetch_class()." : ".$this->db->error()["message"];
                ...
                // add record
                $this->m_ref->setTableName("r_mdl1_item_indi");
                $data_baru = array(
                    "itemid" => $id,
                    "nama"      => $inp_nm,
                    "nourut"    => $inp_nourut,
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                if(!is_numeric($id))
                    throw new Exception("Invalid ID");
                //check data
                $sql= "SELECT id,nama nm FROM r_mdl1_item_indi WHERE id=".$id;
                ...
                $nm = $list_data->row()->nm;
                $this->db->trans_begin();
                $sql= "DELETE FROM r_mdl1_item_indi WHERE id=".$id;
