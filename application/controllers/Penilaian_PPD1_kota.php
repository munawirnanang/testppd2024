...
class Penilaian_PPD1_kota extends CI_Controller {
    ...
    public function index(){
        if($this->input->is_ajax_request()){
            ...
            {                
                ...
                $this->js_init    = "main";
                $this->js_tedit    = "main";
                $this->js_path    = "assets/js/admin/penilaian/penilaian_PPD1_kota.js?v=".now("Asia/Jakarta");
                ...
                $str = $this->load->view($this->view_dir."index_PPD1_kota",$data_page,TRUE);
