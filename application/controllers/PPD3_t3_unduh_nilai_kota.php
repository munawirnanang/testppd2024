...
/*
* Unduh Penilaian kota
* author : FSM
 * date : 06 feb 20202
*/
class PPD3_t3_unduh_nilai_kota extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->input->is_ajax_request()) {
            try {
                ...
                $this->js_init    = "main";
                $this->js_tedit    = "main";
                $this->js_path    = "assets/js/ppd3/PPD3_unduh_nilai/t3/unduh_nilai_kota_t3.js?v=" . now("Asia/Jakarta");
    ...
    function Download_nilai()
    {
        ...
        $select = "SELECT W.id,W.iduser,W.idkabkot, P.nama_kabupaten, U.userid
                    ...
                    JOIN `kabupaten` P ON W.idkabkot = P.id AND P.urutan=1
