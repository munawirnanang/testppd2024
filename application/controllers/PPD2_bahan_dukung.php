 ...
 * date : 10 des 2020
*/
class PPD2_bahan_dukung extends CI_Controller
{
    var $view_dir   = "ppd2/PPD2_bahan_dukung/";
    var $js_init    = "main";
    var $js_path    = "assets/js/ppd2/PPD2_bahan_dukung/ppd2.js";
    ...
    public function index()
    {
        if ($this->input->is_ajax_request()) {
            try {
                ...
                $this->js_init    = "main";
                $this->js_tedit    = "main";
                $this->js_path    = "assets/js/ppd2/PPD2_bahan_dukung/bahan_dukung.js?v=" . now("Asia/Jakarta");
