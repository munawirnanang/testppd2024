        ...
        if ($this->input->is_ajax_request()) {
            try {
                ...
                if ($inp_katewlyh == "PROV") {
                    ...
                    //                        $tmp_prov .= " data-nmwlyh='".$v->nmprov."'";
                    //                        $str.="<td><center><a href='javascript:void(0)' ".$tmp_prov." class='btn btn-primary btn-sm' style='border-radius: 5px;'>Download Bahan Dukung <i class='mdi mdi-download' aria-hidden='true' style='padding-left: 5px;'></i></a></center></td>";
                    //                        //status
                    //                        $prcntg = $jml_item==0?0:$v->jml/$jml_item*100;
                    //
                    //                        $str_tmp = number_format($prcntg,2)."&nbsp;%";
        ...
        if ($this->input->is_ajax_request()) {
            try {
                ...
                if ($kate_wlyh == "PROV") {
                    ...
                    //cek data 
                    $this->m_ref->setTableName("t_mdl31_resume_kabkota");
                    $select = array();
                    $cond = array(
                        "mapid"  => $idmap,
                        "aspekid" => $idaspek,
