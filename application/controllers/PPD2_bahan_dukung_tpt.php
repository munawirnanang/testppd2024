    ...
    public function index()
    {
        if ($this->input->is_ajax_request()) {
            try {
                ...
                //common properties
                $this->js_init    = "main";
                $this->js_path    = "assets/js/ppd2/PPD2_bahan_dukung/bahan_dukung_tpt.js?v=" . now("Asia/Jakarta");
