...
class M_Kertaskerja_Prov extends CI_Controller {
    var $view_dir   = "ppd1/kertaskerja/";
    var $js_init    = "main";
    ...
    public function index(){
        if($this->input->is_ajax_request()){
            ...
            {                
                ...
                //common properties
                $this->js_init    = "main";
                $this->js_path    = "assets/js/admin/kertaskerja/kertaskerja_prov.js?v=".now("Asia/Jakarta");
